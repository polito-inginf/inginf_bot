...
*/
function sendMessage($chatId, $text, $flags = 0, $keyboard = []) {
	$parseMode = 'HTML';
	$disablePreview = TRUE;
	$mute = FALSE;
...
* @return mixed The result of the encode
*/
function editMessageReplyMarkup($keyboard, $chatId, $messageId) {
	/**
	* Encode the keyboard layout
	*
	* json_encode() Convert the PHP object to a JSON string
...
* @return mixed The result of the encode
*/
function editMessageText($chatId, $messageId, $text, $flags = 0, $keyboard = []) {
	$parseMode = 'HTML';
	$disablePreview = TRUE;
...
* @return mixed The result of the encode
*/
function answerInlineQuery($queryId, $ans) {
	/**
	* Encode the keyboard layout
	*
	* json_encode() Convert the PHP object to a JSON string
